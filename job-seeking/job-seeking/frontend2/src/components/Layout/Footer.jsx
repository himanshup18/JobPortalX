...
export default function FooterThree() {
  return (
    ...
    //             <img className="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-logo-indigo-600-mark-gray-800-text.svg" alt="Workflow logo" />
    //             <span className="ml-4 text-lg font-bold">JobSeeker</span>
    //           </div>
    //         </a>
    //       </div>
    //       <div className="w-auto p-8">
